...
public class ShopInfo {
    ...
    public String getFoodLicenseCode() {
        return foodLicenseCode;
    }

    public void setFoodLicenseCode(String foodLicenseCode) {
        this.foodLicenseCode = foodLicenseCode;
    }
    ...
    public String getOtherEnclosure() {
        return otherEnclosure;
    }

    public void setOtherEnclosure(String otherEnclosure) {
        this.otherEnclosure = otherEnclosure;
    }
