                    ...
                    <div class="widget-body fuelux">
                        <div class="widget-body fuelux">
                            ...
                            <div class="step-content">
                                <form id="addForm" class="smart-form" returnUrl="/productCategory/findProductCategory.do" action="/productCategory/editProductCategory.do" method="post">
                                            ...
                                            <div class="row">
                                                <section>
                                                    <label class="input"> <i class="icon-append fa fa-user"></i>
                                                        ...
                                                        <input type="text" name="name" placeholder="分类名称" value="${p.name}">
                                                    </label>
                                                    </label>
                                                </section>
                                            </div>
                                            ...
                                            <div class="row">
                                                <section >
                                                    <label class="textarea textarea-resizable"><i class="icon-append fa fa-comment"></i>
                                                        <textarea rows="3" name="remark" placeholder="备注" class="custom-scroll">${p.remark}</textarea>
                                                    </label>
                                                </section>
                                            </div>
                                        </fieldset>
