				    ...
				    <div class="widget-body fuelux">
				        <div class="widget-body fuelux">
						 ...
						 <div class="step-content">
				             <form id="addForm" enctype="multipart/form-data" class="smart-form" returnUrl="/operatorController/findOperator.do" action="/operatorController/updateOperatorById.do" method="post">
										...
										<div class="row">
											<section class="col col-6">
												<label class="input"> <i class="icon-append fa fa-user"></i>
													...
													<input type="text" name="loginName" placeholder="用户名" readonly="readonly" value="${o.loginName}">
													 </label>
												</label>
											</section>
											<section class="col col-6">
										...
										<div class="row">
											...
											<section class="col col-6">
												<label class="input"> <i class="icon-append fa fa-calendar"></i>
													<input type="text" data-icon="fa fa-calendar"  name="validDate" value="${o.validDate}"   onfocus="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})" placeholder="账号有效期">
												</label>
											</section>
										</div>
									...
									<div class="row">
											<section class="col col-6">
												<div class="input input-file">
													 <span class="button"><input id="file"  type="file" name="file"  onchange="readURL(this);">浏览</span><input type="text"  value="${o.imgPath}" placeholder="请选择头像" readonly="">
...
<script src="${resources_static}/js/operator/edit.js"></script>
