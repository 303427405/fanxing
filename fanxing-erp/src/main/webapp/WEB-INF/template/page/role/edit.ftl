				    ...
				    <div class="widget-body fuelux">
				        <div class="widget-body fuelux">
						 ...
						 <div class="step-content">
				             <form id="addForm"  class="smart-form" returnUrl="/roleController/findRole.do" action="/roleController/updateRoleById.do" method="post">
										...
										<div class="row">
											<section>
												...
												<input type="hidden" id="roleId" name="id" value="${r.id}">
													<input type="text" name="roleName" value="${r.roleName}" placeholder="角色名称">
													 </label>
												</label>
											</section>
										</div>
										<div class="row">
										 <section >
												<label class="textarea textarea-resizable"><i class="icon-append fa fa-comment"></i>
													<textarea rows="3" name="description" placeholder="角色描述" class="custom-scroll">${r.description}</textarea>
												</label>
											</section>
										</div>
								</fieldset>
				              ...
				              <div class="step-pane" id="step2">
				                <fieldset>
			                		<div class="row">
										<section>
											<button id="selectAllByTree" class="btn btn-info btn-xs">全选</button>
											<button id="SelectNoneByTree" class="btn btn-info btn-xs">取消全选</button>
											<button id="refreshByTree" class="btn btn-info btn-xs">刷新模块树</button>
											<input type="text"  readonly="readonly"  style='border: 0px;color: white;background-color: white;' value="${r.permissionIds}" id="permissionIds" name="permissionIds">
										</section>
									</div>
									<div class="row">
											<section>
