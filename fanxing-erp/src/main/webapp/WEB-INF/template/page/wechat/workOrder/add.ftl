				    ...
				    <div class="widget-body fuelux">
				        <div class="widget-body fuelux">
						 ...
						 <div class="step-content">
				             <form id="addForm" class="smart-form" returnUrl="/workOrderController/findWorkOrder.do" action="/workOrderController/addWorkOrderNoAuth.do" method="post">
				              <div class="step-pane active" id="step1">
				                 <fieldset>
										<div class="row">
											...
											<select id="moreSelect"  name="wechatId"/>
										</div>
										<div class="row">
											<section class="col col-6">
												<select id="dictionaryData" data-css="true" data-code='softServiceType' data-placeholder="维修类型"   name="type"/>
											</section>
											<section class="col col-6">
